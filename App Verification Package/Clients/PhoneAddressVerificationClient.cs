...
{
    public class PhoneAddressVerificationClient
    {
        private const string apiName = "PhoneAddressVerification";

        private readonly MBClient client;

        public PhoneAddressVerificationClient(MBClient mbClient)
        {
